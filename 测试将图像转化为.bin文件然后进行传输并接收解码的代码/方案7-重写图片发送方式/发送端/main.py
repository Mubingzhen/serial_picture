...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def start_send(self):
        thread=threading.Thread(target=self.send_picture,args=())
    ...
    def send_picture(self):
        if self.UI.label_graphics.pixmap() is None:
            ...
            with open(self.file_path, 'rb') as f:
                        ...
                        self.sendbits=self.file_size
                        self.UI.label_sendshow.setText(str(self.file_size))
    ...
    def start_openser(self):
        thread = threading.Thread(target=self.openser,args=())
        thread.setDaemon(True)
        thread.start()
    def sendclear(self):
